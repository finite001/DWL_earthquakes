...
create_dw_table = PostgresOperator(
...
get_missing_data = PostgresOperator(
...
create_dw_table >> combine_tables >> clean_data >> delete_table 
create_dw_table >> get_missing_data >> clean_data >> delete_table
